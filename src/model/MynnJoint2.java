...
//				new int[]{outputLengthWordLookup, outputLengthWordLookup, outputLengthWordLookup});
		...
		//				new int[]{averageTags.outputLength, userLookup.output.length, itemLookup.output.length});
		connectItem = new MultiConnectLayer(
				new int[]{averageTags.outputLength, averageWeibos.outputLength,itemLookup.output.length});

		averageTags.link(connectItem, 0);
		averageWeibos.link(connectItem, 1);
		//		userLookup.link(connectItem, 1);
		itemLookup.link(connectItem, 2);
...
//						wordTagsVocab.get(unkStr));
				...
				itemLookup.input[0] = itemVocab.get(dataTags.productStr);
			...
			Funcs.dumpEmbedFile(dumpItemEmbeddingFile+"\\tags.txt" + "-" + round, "utf8", itemVocab, itemLookup.table, itemLookup.embeddingLength);
...
//					wordTagsVocab.get(unkStr));
	...
	public static void main(String[] args) throws Exception{
		...
		MynnJoint2 main = new MynnJoint2(
				embeddingFileTags, 
				embeddingLengthTags, 
				embeddingFileWeibos, 
