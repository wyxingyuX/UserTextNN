...
public class Mynn_1linear_auto {
	...
	public static void expRun(String sourceBase,String destBase,List<ViewInfo> viewInfos,int roundNum,int totalFold) throws Exception{
		...
		for(int fold=0;fold<totalFold;++fold){
			...
			Mynn_1linear_auto main = new Mynn_1linear_auto(
					views,
...
//		addExpView(sourceBase,"tag(TmxId_w2v)_avgFriNum",viewsI);
//		expViewInfos.add(viewsI);
//
		List<ViewInfo> viewsJ=new ArrayList<ViewInfo>();
		addExpView(sourceBase,"weibo(10x20)",viewsJ);
		expViewInfos.add(viewsJ);

//		List<ViewInfo> viewsK=new ArrayList<ViewInfo>();
//		addExpView(sourceBase,"simTh0.8(id_w2v)\\weibo(10x20)(Wm.xId_avgW20)",viewsK);
//		expViewInfos.add(viewsK);
	...
	public static void addExpView(String sourceBase,String viewName,List<ViewInfo> views) throws IOException
	{
		...
		views.add(new ViewInfo(viewName,embeddingFileView,embeddingLengthView,allDataView));
	}
